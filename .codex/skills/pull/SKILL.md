...
8. Verify with project checks if defined (check `AGENTS.md`, `CLAUDE.md`, or
   `CONTRIBUTING.md`; otherwise `uvx pytest -v` if a test suite exists).
...
- The branch is not the intended target, or the remote/branch names do not
